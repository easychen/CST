...
/** @type {string} */
const basicAuthUser = cliArguments.basicAuthUserName?? getConfigValue('basicAuthUser.username', '');
/** @type {string} */
const basicAuthPass = cliArguments.basicAuthUserPassword?? getConfigValue('basicAuthUser.password', '');
...
if (listen && basicAuthMode) {
        app.use((req, res, next) => basicAuthMiddleware(req, res, next, basicAuthUser, basicAuthPass));
    }
